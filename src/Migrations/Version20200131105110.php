 ...
 */
final class Version20200131105110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE t_subChapters (id INT AUTO_INCREMENT NOT NULL, subName VARCHAR(255) NOT NULL, subNumber INT NOT NULL, fkChapter INT NOT NULL, fkLevel INT DEFAULT NULL, INDEX IDX_6596B8AFEFA103A1 (fkChapter), INDEX IDX_6596B8AF8A304D32 (fkLevel), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE t_exams (idExam INT AUTO_INCREMENT NOT NULL, exaName VARCHAR(255) NOT NULL, exaCreationDate VARCHAR(255) DEFAULT NULL, duration VARCHAR(255) NOT NULL, fkSubject INT NOT NULL, INDEX IDX_D7807551EDEE88F5 (fkSubject), PRIMARY KEY(idExam)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE t_questions (idQuestion INT AUTO_INCREMENT NOT NULL, fkSubChapter INT DEFAULT NULL, queQuestion VARCHAR(255) NOT NULL, queAnswer VARCHAR(255) NOT NULL, quePoints INT NOT NULL, queFormula LONGTEXT DEFAULT NULL, fkImage INT DEFAULT NULL, INDEX IDX_1B60D23D5E7857E (fkImage), PRIMARY KEY(idQuestion)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
